...
| **Full URL** | `https://api.spotify.com/v1/me/player/recently-played` |
| **Auth** | oauth_2_0 (scopes: user-read-recently-played) |
...
```jsonc
{
  ...
  "items": [  // array of PlayHistoryObject, optional
    {
      "track": {
        "album": {
      ...
      "played_at": "string",  // string, format: date-time, optional, The date and time the track was played.
      "context": {
