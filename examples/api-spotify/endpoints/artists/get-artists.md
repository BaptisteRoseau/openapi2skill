...
| **Method** | `GET` |
| **URL** | `/artists` |
| **Full URL** | `https://api.spotify.com/v1/artists?ids=2CIMQHirSU0MQqyYHq0eOx,57dN52uHvrHOxijzpIgu3E,1vCWHaC5f2uS3yhpwWbIA6` |
| **Auth** | oauth_2_0 |
...
```jsonc
{
  "artists": [  // array of ArtistObject, required
    {
      "external_urls": {
