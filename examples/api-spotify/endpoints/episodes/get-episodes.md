...
| **Method** | `GET` |
| **URL** | `/episodes` |
| **Full URL** | `https://api.spotify.com/v1/episodes?ids=77o6BIVlYM3msb4MMIL1jH,0Q86acNRm6V9GYx55SXKwf` |
| **Auth** | oauth_2_0 (scopes: user-read-playback-position) |
...
```jsonc
{
  "episodes": [  // array of EpisodeObject, required
    {
