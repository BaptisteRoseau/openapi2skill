...
| **Method** | `GET` |
| **URL** | `/me/episodes` |
| **Full URL** | `https://api.spotify.com/v1/me/episodes` |
| **Auth** | oauth_2_0 (scopes: user-library-read, user-read-playback-position) |
...
```jsonc
{
  ...
  "items": [  // array of SavedEpisodeObject, required
    {
      "added_at": "string",  // string, format: date-time, optional, The date and time the episode was saved. Timestamps are returned in ISO 8601 format as Coordinated Universal Time (UTC) with a zero offset: YYYY-MM-DDTHH:MM:SSZ.
      "episode": {
