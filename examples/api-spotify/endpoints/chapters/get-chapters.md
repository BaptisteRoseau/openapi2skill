...
| **Method** | `GET` |
| **URL** | `/chapters` |
| **Full URL** | `https://api.spotify.com/v1/chapters?ids=0IsXVP0JmcB2adSE338GkK,3ZXb8FKZGU0EHALYX6uCzU,0D5wENdkdwbqlrHoaJ9g29` |
| **Auth** | oauth_2_0 |
...
```jsonc
{
  "chapters": [  // array of ChapterObject, required
    {
