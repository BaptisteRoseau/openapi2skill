...
| **Method** | `GET` |
| **URL** | `/audiobooks` |
| **Full URL** | `https://api.spotify.com/v1/audiobooks?ids=18yVqkdbdRvS24c0Ilj2ci,1HGw3J3NxZO1TP1BTtVhpZ,7iHfbu1YPACw6oZPAFJtqe` |
| **Auth** | oauth_2_0 |
...
```jsonc
{
  "audiobooks": [  // array of AudiobookObject, required
    {
