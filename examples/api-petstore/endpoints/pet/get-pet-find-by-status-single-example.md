...
|--|--|
| **Method** | `GET` |
| **URL** | `/pet/findByStatus/singleExample` |
| **Full URL** | `http://mypetstore.com/api/v1/pet/findByStatus/singleExample?status=string` |
| **Full URL** | `https://127.0.0.1:8080/api/pet/findByStatus/singleExample?status=string` |
